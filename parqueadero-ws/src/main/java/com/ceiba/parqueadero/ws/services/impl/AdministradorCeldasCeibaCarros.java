...
public class AdministradorCeldasCeibaCarros implements AdministradorCeldas {
	...
	public static final double VALOR_HORA = 1000;
	public static final double VALOR_DIA = 8000;
	...
	public AdministradorCeldasCeibaCarros(ClienteDAO clienteDAO) {
	...
	private boolean validarDisponibilidadCeldas() {
		...
		long numCeldasOcupadas = clienteDAO.consultarOcupacionParqueaderoPorTipoVehiculo(TipoVehiculoEnum.CARRO);
	...
	public Cliente retirarCliente(Cliente cliente) throws ClienteException {
		...
		double valor = calcularValorServicioParqueadero(clienteEntity.getFechaIngreso(), clienteEntity.getFechaSalida());
	...
	private double calcularValorServicioParqueadero(Date fechaIngreso, Date fechaSalida) {
